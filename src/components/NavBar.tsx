  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <Link className="flex items-center  text-gray-400" to="/">
          {t("mMain")}
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link className="flex items-center text-gray-400" to="/about">
          {t("mAbout")}
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link className="flex items-center  text-gray-400" to="/menu">
          {t("mMenu")}
        </Link>
      </Typography>
      <Typography
      ...
      >
        ...
        <Link className="flex items-center  text-gray-400" to="/gallery">
          {t("mGallery")}
        </Link>
      </Typography>
      ...
      >
        ...
        <Link className="flex items-center  text-gray-400" to="/contact">
          {t("mContact")}
        </Link>
      </Typography>
    </ul>
